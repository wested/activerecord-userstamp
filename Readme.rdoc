...
This fork also includes a changes to perform the model stamping before validation is performed so that the model can enforce the presence of stamp attribute values eg.
...
To use this fork add the following to your application gemfile:
	...
	gem 'userstamp', :git => "git://github.com/chrismhilton/userstamp.git"
